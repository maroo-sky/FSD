...
def train(args, train_dataset, teacher, student, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            #input_token = tokenizer.convert_ids_to_tokens(inputs["input_ids"][0])
            ...
            # intra, inter : (loss, T.mean, T.std, S.mean, S.std)
            pkd, dist_inter, cos_inter, dist_intra,  cos_intra = estimate_metrics(teacher_featuremaps, student_featuremaps, args)
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    tb_writer.add_scalar("00.cross_entrophy", (tr_loss - logging_loss) / args.logging_steps, global_step)
                    ...
                    tb_writer.add_scalar("02.total_loss", (tr_total_loss - logging_total_loss) / args.logging_steps,
                                         global_step)
                    tb_writer.add_scalar("03.logit_loss", (tr_logit_loss - logging_logit_loss) / args.logging_steps,
                                         global_step)
                    tb_writer.add_scalar("04.cka_loss",
                                         (tr_cka_loss - logging_cka_loss) / args.logging_steps, global_step)
